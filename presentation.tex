...
\pgfdeclareimage[width=.30\paperwidth]{foxit}{foxit}
\pgfdeclareimage[width=.85\paperwidth]{DW}{DW}
\title{}
\date{24th of November 2012}
\begin{document}
\section{Saturday}
\IntroFrame{The 2012 Northwestern Europe Regional Contest}{24th of November 2012}
\subsection{Opening Ceremony}
\IntroFrame[tudelft]{Welcome to the\\Delft University of Technology}{Professor Rob Fastenau\\ Dean of the Faculty EEMCS}
\begin{frame}
	...
	\item Balloons 
	\item Medals 
	\item World final places in St. Petersburg
	\item Owls 
	\item 3rd place: \euro 256,-
	\item 2nd place: \euro 512,-
	\item 1st place: \euro 1024,
\end{itemize}
\end{frame}
\begin{frame}
...
\end{frame}
% \SuccessFrame
\IntroFrame{The 2012 Northwestern Europe Regional Contest}{Bastiaan Gris\`el}
\begin{frame}
	\frametitle{Schedule}
	\tableofcontents
\end{frame}
\begin{frame}[c]
	...
	\begin{pgfpicture}
		\pgftext[at=\pgfpoint{.15\paperwidth}{-.98\paperheight}, left, base]{\pgfuseimage{DW}}
	\end{pgfpicture}
\end{frame}
\begin{frame}
...
\QuestionsFrame
\subsection{Talk Fox-IT}
\IntroFrame[foxit]{''Can you stop on-line bank robbers with Bayesian Prediction?''}{Eward Driehuis, Productmanager Cybercrime}
\subsection{Dinner}
\ProgramFrame{Dinner}
\section{Sunday}
