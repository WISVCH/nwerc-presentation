...
\begin{document}
\section{Saturday}
\IntroFrame{The 2013 Northwestern Europe Regional Contest}{22nd of November 2013}
\subsection{Opening Ceremony}
\IntroFrame[tudelft]{Welcome to the\\Delft University of Technology}{Peter Kluit\\ Emiratus Proffessor of the Faculty EEMCS}
\begin{frame}
...
\IntroFrame[tomtom]{''Can you stop on-line bank robbers with Bayesian Prediction?''}{Eward Driehuis, Productmanager Cybercrime}
\subsection{Dinner}
\ProgramFrame{Dinner}
\section{Sunday}
